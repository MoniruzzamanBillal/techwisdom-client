...
const AdminDeleteModal = ({ handleDeleteFunction, id }: TPostDeleteProps) => {
  return (
    <div className="AdminDeleteModalContainer">
      <AlertDialog>
        {/* alert trigger  */}
        ...
        <AlertDialogContent>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete admin
