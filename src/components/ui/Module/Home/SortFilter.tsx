...
const SortFilter = ({searchTerm ,setSearchTerm ,sort ,setSortBy} : TProps) => {
  return (
    <div className="SortFilterContainer">
      <div className="sortSearch  bg-black100 shadow-md rounded border border-gray-300 py-2 px-3 flex flex-col gap-y-4 md:flex-row justify-between items-center text-gray-100 ">
        {/* search section   */}
        {/* bg-black100 */}
        <div className="searchSection bg-black100 border border-gray-300 w-[94%] xsm:w-[85%] sm:w-[75%] md:w-[56%] xl:w-[64%] xlm:w-[60%] m-auto py-1 px-3 rounded-full flex justify-center items-center    ">
          <Input
            type="text"
        ...
        <div className="sortSection  flex  justify-between items-center gap-x-1 ">
          ...
          >
            ...
            <SelectContent className=" bg-black100 ">
              ...
              <SelectItem className="text-gray-50" value={"a" }>
            Default
              </SelectItem>
