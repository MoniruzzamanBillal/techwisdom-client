...
const BlogCardLoading = () => {
  return (
    <div className="BlogCardLoadingContainer my-4">
      <div className="BlogCardLoadingWrapper rounded-md bg-black100  p-5 pt-8 flex flex-col  md:flex-row   justify-between items-center gap-x-3 gap-y-8 shadow">
        ...
        <div className="skeletonLeft flex flex-col gap-y-5 ">
          ...
          <div className="titleSkeleton">
            <Skeleton className=" h-[1.4rem] w-[18rem] " />
          </div>
          {/* title skeleton  */}

          {/* description skeleton  */}
          <div className="descriptionSkeleton">
            <Skeleton className=" h-[4rem] w-[38rem] " />
          </div>
          {/* description skeleton  */}
